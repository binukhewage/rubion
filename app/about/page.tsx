    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-300 selection:bg-lime-400 selection:text-black overflow-x-hidden py-50">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-12 items-start mt-12">
             <p className="text-lg text-zinc-400 leading-relaxed max-w-xl ">
               Rubion is more than a web agency. We are a technical partner for brands that refuse to compromise on quality. 
               <br/>We combine aesthetic minimalism with robust software engineering to build products that scale.
               We focus on clarity, performance, and long-term value. We partner with startups, entrepreneurs, and brands to design and develop websites that are built with purpose.
             </p>
             ...
             <div className="grid grid-cols-2 gap-4 w-full md:w-auto">
                <div className="p-4 border border-zinc-800 bg-zinc-900/30 rounded-xl min-w-[140px]">
                   ...
                   <div className="text-[10px] uppercase tracking-wider text-zinc-500 font-mono">Uptime Focus</div>
                </div>
                <div className="p-4 border border-zinc-800 bg-zinc-900/30 rounded-xl min-w-[140px]">
                   <div className="text-2xl font-bold text-white mb-1">0.1s</div>
                   <div className="text-[10px] uppercase tracking-wider text-zinc-500 font-mono">Latency Target</div>
                </div>
             </div>
          </div>
        </motion.div>
         ...
         <div className="max-w-7xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
               ...
               <div className="space-y-6 text-zinc-400 leading-relaxed text-lg">
                  <p>
                     The modern web has a weight problem. Too many sites are built on heavy templates that load slowly and break easily.
                  </p>
                  <p>
                     We take a different approach. We write clean, semantic code from scratch. We optimize assets. We use edge caching. 
                     The result? Websites that feel instant and rank higher on search engines.
                  </p>
               </div>
            </div>
      ...
      <section className="relative z-10 px-6 pt-32 max-w-7xl mx-auto">
        ...
        >
          ...
          {/* UPDATED HEADER TEXT */}
          <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tighter mb-6">Why Ru<span className="text-lime-400">B</span>ion?</h2>
          <p className="text-zinc-400 text-lg leading-relaxed">
            In a digital landscape crowded with generic templates and quick fixes, we stand for precision. 
            RuBion bridges the gap between creative ambition and technical reality, delivering software 
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 p-8 h-full flex flex-col">
         ...
         <h3 className="text-xl font-bold text-white mb-3 group-hover:text-lime-400 transition-colors">{item.title}</h3>
     ...
     >
       ...
       <div className="relative z-20 p-8 h-full flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Ready for a project?</h3>
            <p className="text-zinc-400 text-sm leading-relaxed mb-8">
               Skip the guesswork. Let's discuss your requirements and build something exceptional.
            </p>
          </div>
