...
export default function Contact() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    // 2. Format the Message (using WhatsApp Markdown)
    // %0A represents a line break in URL encoding
    const phoneNumber = "94701648169"; // Your WhatsApp Number

    const message = `
*New Project Inquiry via RuBion Website* 
          ...
          <div className="lg:col-span-2 pt-8">
            ...
            >
              ...
              <p className="text-zinc-400 leading-relaxed text-sm">
                We help ambitious brands build high-performance digital
                products. Fill out the form, and we'll be in touch instantly via
                WhatsApp.
              </p>
            </motion.div>
          ...
          <div className="lg:col-span-3">
            ...
            >
              <div className="space-y-8">
                ...
                <button
                  type="submit"
                  className="w-full bg-lime-400 text-black h-14 rounded-xl font-bold text-sm uppercase tracking-wider hover:bg-lime-300 transition-colors flex items-center justify-center gap-2 group"
                >
                  Send via WhatsApp
