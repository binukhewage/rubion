...
const reviews = [
  {
    ...
    content:
      "Working with rubion.dev transformed our online presence. Their attention to detail and technical expertise is unmatched.",
    rating: 5,
    avatar: "/avatar1.jpg",
  },
  {
    ...
    content:
      "The e-commerce platform they built increased our sales by 300%. Exceptional service from start to finish.",
    rating: 5,
    avatar: "/avatar2.jpg",
  },
  {
    ...
    content:
      "Professional, creative, and always on time. Our website loads faster than any competitor in our industry.",
    rating: 5,
    avatar: "/avatar3.jpg",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Project timelines vary based on complexity. A standard website takes 4-6 weeks, while e-commerce platforms typically require 8-12 weeks. We provide detailed timelines during our initial consultation.",
  },
  {
    id: 2,
    question: "Do you offer ongoing maintenance and support?",
    answer:
      "Yes, we offer various support packages including security updates, performance monitoring, content updates, and technical support. We ensure your website remains secure and up-to-date.",
  },
  {
    id: 3,
    question: "What's included in your development process?",
    answer:
      "Our process includes discovery & strategy, design & prototyping, development, quality assurance, launch, and post-launch support. We maintain transparent communication throughout.",
  },
  {
    id: 4,
    question: "Can you work with our existing design or brand?",
    answer:
      "Absolutely! We can work with your existing brand guidelines or create new designs from scratch. We're flexible and adapt to your specific needs.",
  },
  {
    id: 5,
    question: "What technologies do you specialize in?",
    answer:
      "We specialize in modern technologies including Next.js, React, TypeScript, Tailwind CSS, Node.js, and various headless CMS platforms like Sanity and Contentful.",
  },
];
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white text-zinc-900 selection:bg-lime-300 selection:text-black overflow-x-hidden py-40">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-24 md:pt-20 md:pb-32">
        <div className="flex flex-col md:flex-row">
          ...
          >
            ...
            >
              Your{" "}
              <span className="bg-zinc-900 text-white px-4 rounded-xl inline-block transform -rotate-2">
                Trusted
              </span>{" "}
              Partner <br />
              For Web{" "}
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 relative">
            ...
            <motion.div variants={fadeInUp} className="hidden md:flex gap-4">
              <button className="w-12 h-12 rounded-full border border-zinc-700 flex items-center justify-center hover:bg-zinc-800 transition-colors">
      ...
      <section className="relative z-10 px-6 py-20 max-w-7xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-8">
            ...
            <span className="bg-zinc-900 text-white px-2 rounded-lg">
              Digital Solutions
            </span>{" "}
            For Growing Brands
          </h2>
          ...
          <p className="max-w-2xl mx-auto text-zinc-600 text-lg mb-12">
            From concept to launch, we build scalable digital solutions that
            help businesses grow with confidence in the digital space.
          </p>
        </motion.div>
      </section>
      ...
      <section className="relative z-10 px-4 md:px-6 pb-20">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 relative z-10">
            <div>
              <div className="inline-flex items-center gap-2 border border-zinc-700 px-3 py-1 rounded-full text-xs uppercase mb-4">
                <ArrowRight className="w-3 h-3 -rotate-45 text-lime-400" /> Work
                Process
              </div>
            ...
            <a
              href="/portfolio"
              className="hidden md:flex items-center gap-2 text-sm font-medium hover:text-lime-400 transition-colors mt-6 md:mt-0"
            >
          ...
          <div className="mt-8 flex md:hidden justify-center">
            <a
              href="/portfolio"
              className="flex items-center gap-2 text-sm font-medium hover:text-lime-400 transition-colors"
            >
              View All Work <ArrowRight className="w-4 h-4" />
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-bold mb-6 text-zinc-900">
              Trusted by{" "}
              <span className="bg-zinc-900 text-white px-4 rounded-xl transform -rotate-1 inline-block">
                Businesses
              </span>{" "}
              Worldwide
            </h2>
      ...
      {/* --- Newsletter Section (Updated for Consistency) --- */}
      <section className="relative z-10 px-4 md:px-6 pb-20">
      <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-zinc-600 text-lg max-w-2xl mx-auto">
            Curated thoughts on modern web development, performance, and scalable
            digital products.
            </p>
          </motion.div>
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
          variants={fadeInUp}
          className="bg-zinc-950 text-white rounded-[2.5rem] p-8 md:p-16 max-w-7xl mx-auto relative overflow-hidden shadow-2xl"
        >
          {/* Background Glow (Consistent with other sections) */}
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-lime-900/20 rounded-full blur-[120px]" />
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              <div className="inline-flex items-center gap-2 border border-zinc-700 bg-zinc-900/50 px-4 py-1 rounded-full text-xs uppercase tracking-widest mb-6 text-zinc-300">
                <Mail className="w-3 h-3 text-lime-400" /> Weekly Digest
              </div>
              
              <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                Unlock the secrets of <br />
                <span className="text-lime-400">Modern Web Dev.</span>
              </h2>
              
              <p className="text-zinc-400 text-lg max-w-md">
                Join us to get actionable tips, code snippets, and career advice delivered straight to your inbox. <br/><br/>
              </p>
            ...
            <div className="w-full bg-zinc-900/50 border border-zinc-800 p-6 md:p-8 rounded-3xl backdrop-blur-sm">
              {isSubscribed ? (
                <motion.div 
                ...
                >
                  ...
                  <p className="text-zinc-400">Keep an eye on your inbox for the welcome email.</p>
                </motion.div>
              ) : (
                <motion.form 
                ...
                >
                  <div className="space-y-2">
                    <div className="relative group">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-4 bg-zinc-950 border border-zinc-800 rounded-xl text-white placeholder:text-zinc-600 focus:ring-2 focus:ring-lime-400/50 focus:border-lime-400 outline-none transition-all"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="w-full bg-white text-zinc-950 font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-lime-400 transition-colors"
                  >
